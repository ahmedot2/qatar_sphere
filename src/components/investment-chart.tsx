  ...
  return (
    <ChartContainer config={chartConfig} className="h-full w-full">
        <BarChart data={chartData} layout="vertical" margin={{ left: 10, right: 20, top: 10, bottom: 10 }}>
            ...
            <XAxis type="number" dataKey="investment" unit="B" axisLine={false} tickLine={false} tick={{ fill: 'hsl(0 100% 99%)' }} />
            <YAxis dataKey="category" type="category" tickLine={false} axisLine={false} width={80} tick={{ fill: 'hsl(0 100% 99%)' }}/>
