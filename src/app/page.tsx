    ...
    <div className="bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-24">
        ...
        <section className="text-center py-16" id="home">
          ...
          <Card className="mt-12 w-full max-w-5xl mx-auto shadow-2xl overflow-hidden">
            <Image
        ...
        <section id="vision" className="py-16">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card><CardHeader><Cpu className="h-8 w-8 mb-2 text-primary" /><CardTitle>The Proposal</CardTitle></CardHeader><CardContent>$4.2B to develop the world's first 'cognitive city' district.</CardContent></Card>
            <Card><CardHeader><DollarSign className="h-8 w-8 mb-2 text-primary" /><CardTitle>The Dual Engine</CardTitle></CardHeader><CardContent>Adds QAR 20-30B annually to GDP.</CardContent></Card>
            <Card><CardHeader><TrendingUp className="h-8 w-8 mb-2 text-primary" /><CardTitle>The Strategic Imperative</CardTitle></CardHeader><CardContent>A living laboratory for AI, Quantum Computing, and Robotics.</CardContent></Card>
            <Card><CardHeader><Gem className="h-8 w-8 mb-2 text-primary" /><CardTitle>The Ask</CardTitle></CardHeader><CardContent>Seeking QIA's backing to anchor this nation-building project.</CardContent></Card>
          </div>
        </section>
        ...
        <section id="financials" className="py-16">
            <div className="text-center mb-12">
              ...
              <p className="max-w-3xl mx-auto mt-4 text-muted-foreground">
                A sound and highly profitable national investment built on rigorous analysis and a resilient, diversified revenue strategy. With a simple payback period of ~2.3 years, this project promises substantial returns.
              </p>
            </div>
            <Card className="p-6">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div>
                      <div className="grid grid-cols-2 gap-6 text-center">
                          <div>
                              <p className="text-5xl font-bold text-primary">$4.2B</p>
                              <p className="text-sm text-muted-foreground mt-2">Total Investment</p>
                          </div>
                          <div>
                              <p className="text-5xl font-bold text-primary">$1.8B</p>
                              <p className="text-sm text-muted-foreground mt-2">Projected Annual Revenue</p>
                          </div>
                           <div>
                              <p className="text-5xl font-bold text-primary">~2.3 Yrs</p>
                              <p className="text-sm text-muted-foreground mt-2">Payback Period</p>
                          </div>
                           <div>
                              <p className="text-5xl font-bold text-primary">QAR 20-30B</p>
                              <p className="text-sm text-muted-foreground mt-2">Annual GDP</p>
                          </div>
                      </div>
                      <Button size="lg" variant="outline" className="mt-10 w-full md:w-auto">View Detailed Financials</Button>
                  </div>
                  <div>
                      <InvestmentChart />
                  </div>
